...
models = [{'weight':1e-1, "dims":3}, {'weight':1e-3, "dims":2}]
# models = [{'weight':2.461858e-02, 'learning_rate' :3.113669e-04, "dims":5}]
num_epoches = [20, 30, 40, 50]
for _model in models:
    for epoche in num_epoches:
        ...
        results.append('epoche %d' % epoche)
